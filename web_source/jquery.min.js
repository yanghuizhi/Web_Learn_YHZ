...
(function(e, t) {
    ...
    function ln(e) {
        var t = a,
        n = Gt[e];
        return n || (n = un(e, t), "none" !== n && n || (Pt = (Pt || x("<iframe frameborder='0' width='0' height='0'/>").css("cssText", "display:block !important")).appendTo(t.documentElement), t = (Pt[0].contentWindow || Pt[0].contentDocument).document, t.write("<!doctype html_s><html_s><body>"), t.close(), n = un(e, t), Pt.detach()), Gt[e] = n),
        n
    }
    function un(e, t) {
    ...
    x.extend({
        ...
        ajaxSettings: {
            ...
            accepts: {
                ...
                json: "application/json, text/javascript_s"
            },
            contents: {
                xml: /xml/,
                html: /html/,
    ...
    x.ajaxSetup({
        accepts: {
            script: "text/javascript_s, application/javascript_s, application/ecmascript, application/x-ecmascript"
        },
        contents: {
